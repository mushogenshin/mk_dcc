...
#
# Created: Tue Oct 27 01:01:58 2020
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.SM_preview_nuclei_btn = QtGui.QToolButton(self.swap_master_main_group_box)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_3.addWidget(self.SM_preview_nuclei_btn)
        self.SM_delete_nuclei_btn = QtGui.QToolButton(self.swap_master_main_group_box)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SM_delete_nuclei_btn.sizePolicy().hasHeightForWidth())
        self.SM_delete_nuclei_btn.setSizePolicy(sizePolicy)
        self.SM_delete_nuclei_btn.setStyleSheet("font-size: 10px;")
        self.SM_delete_nuclei_btn.setIcon(icon7)
        self.SM_delete_nuclei_btn.setIconSize(QtCore.QSize(20, 20))
        self.SM_delete_nuclei_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.SM_delete_nuclei_btn.setObjectName("SM_delete_nuclei_btn")
        self.horizontalLayout_3.addWidget(self.SM_delete_nuclei_btn)
        self.SM_swap_selected_btn = QtGui.QToolButton(self.swap_master_main_group_box)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SM_swap_selected_btn.sizePolicy().hasHeightForWidth())
        self.SM_swap_selected_btn.setSizePolicy(sizePolicy)
        self.SM_swap_selected_btn.setStyleSheet("font-size: 10px;")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/baseline_scatter_plot_white_48dp.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.SM_swap_selected_btn.setIcon(icon9)
        self.SM_swap_selected_btn.setIconSize(QtCore.QSize(20, 20))
        self.SM_swap_selected_btn.setToolButtonStyle(QtCore.Qt.ToolButtonTextUnderIcon)
        self.SM_swap_selected_btn.setObjectName("SM_swap_selected_btn")
        self.horizontalLayout_3.addWidget(self.SM_swap_selected_btn)
        ...
        self.horizontalLayout_4.setContentsMargins(22, 0, 0, 0)
        ...
        self.horizontalLayout_4.addWidget(self.SM_swap_use_instancing_check_box)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(QtGui.QApplication.translate("MainWindow", "Status Quo Input", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.SM_delete_nuclei_btn.setText(QtGui.QApplication.translate("MainWindow", "Abort", None, QtGui.QApplication.UnicodeUTF8))
        self.SM_swap_selected_btn.setText(QtGui.QApplication.translate("MainWindow", "Swap Selected", None, QtGui.QApplication.UnicodeUTF8))
